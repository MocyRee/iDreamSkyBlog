    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_type', models.CharField(max_length=1, verbose_name='显示类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence', models.IntegerField(unique=True, verbose_name='排序')),
                ('is_enable', models.BooleanField(default=True, verbose_name='是否启用')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Nav')),
            ],
            options={
                'verbose_name': '导航子菜单',
                'verbose_name_plural': '导航子菜单',
                'ordering': ['sequence'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, default='no-slug', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_comment', models.CharField(choices=[('0', 'yes'), ('1', 'no')], max_length=1, verbose_name='评论开关')),
